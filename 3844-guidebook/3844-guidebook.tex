...
To learn Markdown, complete the tutorial at
\href{https://commonmark.org/help/tutorial/}{CommonMark}. When you've
completed the tutorial, make your first Markdown file in Atom by
following the steps below.

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  In Atom, choose File =\textgreater{} New file.
\item
  Save the file as a Markdown file by choosing File =\textgreater{}
  Save. Name the file markdown-test.md. Be sure to use the .md suffix.
\item
...
\texttt{\#\ H1\textless{}br\textgreater{}\ \ \ \ \ \ \ \ \ \ \ \#\#\ H2\textless{}br\textgreater{}\ \ \ \ \ \ \ \ \ \ \ \#\#\#\ H3}
...
\texttt{1.\ First\ item\ \ \ \ \ \ \ \ \ \ \ 2.\ Second\ item\ \ \ \ \ \ \ \ \ \ \ 3.\ Third\ item}

Unordered List

\texttt{-\ First\ item\ \ \ \ \ \ \ \ \ \ \ \ \ -\ Second\ item\ \ \ \ \ \ \ \ \ \ \ \ \ -\ Third\ item}
